      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <section className="mb-16 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Feature-Sliced Design 아키텍처 기반의 React + Vite 프로젝트입니다.
          </p>
        </section>
            ...
            <ol className="list-inside list-decimal space-y-3 text-sm">
              ...
              <li>
                <span className="text-muted-foreground">
                  <code className="rounded bg-muted px-1">src/main.tsx</code>에서 MSW import 주석 해제
                </span>
              </li>
              <li>
                <span className="text-muted-foreground">
          ...
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p className="text-muted-foreground">
                자세한 사용법은 <a href="https://speckit.dev" className="text-primary underline" target="_blank" rel="noopener noreferrer">speckit.dev</a>를 참고하세요.
              </p>
            </div>
          </div>
        </section>
